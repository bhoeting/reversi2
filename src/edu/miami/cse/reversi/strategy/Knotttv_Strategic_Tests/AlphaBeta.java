...
public class AlphaBeta implements Strategy {
	...
	public Square chooseSquare(Board board) {
		...
		// Send to brendan
		// Object[] possibileMoves = Heuristics.orderMoves(board,
		// initialBoard.getCurrentPossibleSquares().toArray());

		ArrayList<Square> possibileMoves = new ArrayList<>(board.getCurrentPossibleSquares());
		possibileMoves = Heuristics.orderMoves(initialBoard, possibileMoves);
